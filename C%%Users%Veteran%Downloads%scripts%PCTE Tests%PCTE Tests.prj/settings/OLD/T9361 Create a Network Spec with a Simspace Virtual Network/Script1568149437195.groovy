...
WebUI.setText(findTestObject('Page_PCTE Portal/input_EasyWizard_OverviewName'), ('PCTE Test ' + testCode) + ' Simspace250')
...
WebUI.click(findTestObject('Page_PCTE Portal/div_EasyWizard_SimspaceVirtualNetwork'))
...
WebUI.setText(findTestObject('Page_PCTE Portal/input_EasyWizard_OrganizationName'), 'simspace_network')

'Create a name for the external network elements.'
WebUI.setText(findTestObject('Page_PCTE Portal/input_EasyWizard_ExternalDomainName'), 'ext_simspace')

'Create a name for the internal network elements.'
WebUI.setText(findTestObject('Page_PCTE Portal/input_EasyWizard_InternalDomainName'), 'int_simspace')
...
WebUI.click(findTestObject('Page_PCTE Portal/i_EasyWizard_OSDropDown'))

'Delay for a bit to allow the Infastructure section to render and become clickable.'
TestSupport.delay(1)

WebUI.click(findTestObject('Page_PCTE Portal/div_EasyWizard_OSWindows10'))
...
def teardown() {
    ...
    'Close validate window if necessary'
    if (TestSupport.isObjectPresent(findTestObject('Page_PCTE Portal/button_Validate_Close'))) {
        WebUI.click(findTestObject('Page_PCTE Portal/button_Validate_Close'))
    }
    
    'Make sure there is a delete button in the case where the test failed and no network was created'
    if (TestSupport.isObjectPresent(findTestObject('Page_PCTE Portal/button_HardHat_Delete'))) {
        'Delete the current network that was created'
        WebUI.click(findTestObject('Page_PCTE Portal/button_HardHat_Delete'))
