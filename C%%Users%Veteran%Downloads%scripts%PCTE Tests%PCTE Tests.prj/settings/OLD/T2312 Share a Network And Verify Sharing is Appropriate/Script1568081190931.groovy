...
'Click on the checkbox to unshare list with PCTE'
WebUI.click(findTestObject('Page_PCTE Portal/label_Content_SpecSharePCTEList'))

'Click on the checkbox to unshare view with PCTE'
WebUI.click(findTestObject('Page_PCTE Portal/label_Content_SpecSharePCTEView'))

'Enter the name of the user with whom spec is being shared'
WebUI.setText(findTestObject('Page_PCTE Portal/label_Content_SpecShareUsername'), GlobalVariable.user1_username)
...
def teardown() {
    ...
    'Deelete the network spec that was potentially created earlier in the test case'
