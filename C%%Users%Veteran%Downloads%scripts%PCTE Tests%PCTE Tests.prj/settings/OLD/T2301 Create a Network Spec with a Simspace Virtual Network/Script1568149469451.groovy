...
WebUI.setText(findTestObject('Page_PCTE Portal/input_EasyWizard_OverviewName'), 'Simspace250')

'Set the text of the description for the new network being created.'
WebUI.setText(findTestObject('Page_PCTE Portal/textarea_EasyWizard_OverviewDescription'), 'Automated creation of Metova network.')
...
def teardown() {
	...
	'Make sure to close the validation window if it failed validation'
	...
	'Delete the simspace network spec that was created'
	data.deleteNetworkSpec("Simspace250");
