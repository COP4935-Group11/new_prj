...
'Specify username'
WebUI.setText(findTestObject('Page_Log in to pcte/input_SSO_Username'), GlobalVariable.user1_username)

'Specify password'
WebUI.setEncryptedText(findTestObject('Page_Log in to pcte/input_SSO_Password'), GlobalVariable.user1_password)
