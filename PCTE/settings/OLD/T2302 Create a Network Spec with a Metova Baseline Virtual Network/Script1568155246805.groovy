...
WebUI.click(findTestObject('Page_PCTE Portal/div_EasyWizard_MetovaVirtualInternetBase'))
...
def teardown() {
	...
	'Get the instance of the shared data class'
	SharedData data = SharedData.getInstance();

	'Make sure that if the validation is a failure that the popup box is closed'
	...
	'Delete the created network spec'
