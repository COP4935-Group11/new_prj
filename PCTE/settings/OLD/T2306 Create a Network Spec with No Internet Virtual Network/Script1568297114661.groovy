...
WebUI.setText(findTestObject('Page_PCTE Portal/input_EasyWizard_OverviewName'), 'NoInternet250')

'Set the text of the description for the new network being created.'
WebUI.setText(findTestObject('Page_PCTE Portal/textarea_EasyWizard_OverviewDescription'), 'Automated creation of no internet network.')
...
WebUI.click(findTestObject('Page_PCTE Portal/div_EasyWizard_NoInternet'))
...
WebUI.setText(findTestObject('Page_PCTE Portal/input_EasyWizard_OrganizationName'), 'nointernet_network')

'Create a name for the external network elements.'
WebUI.setText(findTestObject('Page_PCTE Portal/input_EasyWizard_ExternalDomainName'), 'nointernet.com')

'Create a name for the internal network elements.'
WebUI.setText(findTestObject('Page_PCTE Portal/input_EasyWizard_InternalDomainName'), 'nointernet.lan')
...
def teardown() {
    ...
    'Make sure that the validation is closed when the validation finds an error'
    ...
    data.deleteNetworkSpec('NoInternet250')
